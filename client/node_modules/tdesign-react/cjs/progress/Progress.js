...
var Progress = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  if (theme === "plump") {
    ...
    progressDom = /* @__PURE__ */React__default["default"].createElement("div", {
      ref: ref,
      className: classNames__default["default"]("".concat(classPrefix, "-progress__bar"), "".concat(classPrefix, "-progress--plump"), (_classNames2 = {}, defineProperty._defineProperty(_classNames2, "".concat(statusClassName), status), defineProperty._defineProperty(_classNames2, "".concat(classPrefix, "-progress--over-ten"), percentage > PLUMP_SEPERATE), defineProperty._defineProperty(_classNames2, "".concat(classPrefix, "-progress--under-ten"), percentage <= PLUMP_SEPERATE), _classNames2)),
      style: trackStyle
