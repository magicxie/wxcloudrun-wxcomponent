...
import { checkIsSubMenu } from './_util/checkMenuType.js';
...
var SubTitleMenu = function SubTitleMenu(props) {
  ...
  return /* @__PURE__ */React.createElement("li", {
    className: classNames("".concat(classPrefix, "-submenu"), _defineProperty({}, "".concat(classPrefix, "-is-opened"), open)),
    onMouseEnter: function onMouseEnter() {
      return handleMouseEvent("enter");
    },
    onMouseLeave: function onMouseLeave() {
    ...
    ref: subMenuRef,
    className: classNames(className, "".concat(classPrefix, "-menu__item"), (_classNames6 = {}, _defineProperty(_classNames6, "".concat(classPrefix, "-is-active"), isActive), _defineProperty(_classNames6, "".concat(classPrefix, "-is-opened"), open), _classNames6)),
    onClick: handleClick,
    style: style
...
var SubMenu = function SubMenu(props) {
  ...
  var childElement = React.Children.map(children, function (item) {
    return checkIsSubMenu(item) ? /*#__PURE__*/React.cloneElement(item, {
      level: level + 1
    }) : item;
  });
