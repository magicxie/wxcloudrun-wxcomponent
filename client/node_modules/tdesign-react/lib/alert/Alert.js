...
import { CloseIcon, CheckCircleFilledIcon, InfoCircleFilledIcon, ErrorCircleFilledIcon } from 'tdesign-icons-react';
...
var _excluded = ["message", "title", "operation", "theme", "icon", "close", "maxLine", "onClose"];
...
var Alert = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return closed ? null : /* @__PURE__ */React.createElement("div", _objectSpread({
    ref: ref,
    className: classNames("".concat(classPrefix, "-alert"), _defineProperty({}, "".concat(classPrefix, "-alert--").concat(theme), true))
