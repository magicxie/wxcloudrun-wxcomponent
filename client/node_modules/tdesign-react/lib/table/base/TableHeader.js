...
var TableHeader = function TableHeader(props) {
  ...
  function getCustomRender(_ref4) {
    ...
    if (typeof title === "string" || /*#__PURE__*/isValidElement(title)) {
      return function () {
        return title;
      };
    }
  ...
  return /* @__PURE__ */React.createElement("thead", null, trsColumns.map(function (trsColumnsItem, rowIndex) {
    return /* @__PURE__ */React.createElement("tr", {
      ...
      var title = column.title,
          ...
          rest = _objectWithoutProperties(column, _excluded2);
      ...
      return /* @__PURE__ */React.createElement(TableCell, _objectSpread({
        type: "title",
        key: colKey,
        colKey: colKey,
        colIndex: colIndex,
