...
var DraggerProgress = function DraggerProgress(props) {
  ...
  }, "\u6587\u4EF6\u5927\u5C0F\uFF1A", returnFileSize(file === null || file === void 0 ? void 0 : file.size)), /* @__PURE__ */React.createElement("small", {
    className: "".concat(classPrefix, "-size-s")
  }, "\u4E0A\u4F20\u65E5\u671F\uFF1A", getCurrentDate()), !["success", "fail"].includes(file === null || file === void 0 ? void 0 : file.status) && /* @__PURE__ */React.createElement("div", {
  ...
  }, "\u53D6\u6D88\u4E0A\u4F20"), /* @__PURE__ */React.createElement(Button, {
    theme: "primary",
    variant: "text",
    onClick: onUpload
  }, "\u70B9\u51FB\u4E0A\u4F20")), showResultOperate && /* @__PURE__ */React.createElement("div", {
